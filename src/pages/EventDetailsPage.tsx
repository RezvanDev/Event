...
const EventDetailsPage: React.FC = () => {
  ...
  const event = {
    ...
    title: 'Название',
    city: 'Город',
    description: 'Sorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie.Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus.',
    rating: 5.0,
    category: 'Фестиваль',
    format: 'Оффлайн',
    address: 'Адрес',
